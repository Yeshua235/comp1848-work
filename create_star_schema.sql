...
CREATE TABLE dim_author (
  author_id     VARCHAR2 (50) PRIMARY KEY, -- stg_meta.author_id
...
CREATE TABLE dim_product (
  ...
  author_id  VARCHAR2(50) REFERENCES dim_author(author_id), -- stg_meta.author_id
...
-- Drop dim_product first (it references dim_author)
DROP TABLE dim_product CASCADE CONSTRAINTS;

-- Then drop dim_author
DROP TABLE dim_author CASCADE CONSTRAINTS;

-- Now rerun the CREATE TABLE statements for dim_author and dim_product from create_star_schema.sql